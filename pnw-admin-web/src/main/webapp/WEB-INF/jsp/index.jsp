		            ...
		            <div class="panel-heading">
		              <div class="stat">
		                ...
		                <div class="row">
		                  ...
		                  <div class="col-xs-8">
		                    <small class="stat-label">今日服务人数</small>
		                    <h1>6700</h1>
		                  </div>
		                </div><!-- row -->
		                ...
		                <div class="row">
		                  <div class="col-xs-6">
		                    <small class="stat-label">生成订单数</small>
		                    <h4>3030</h4>
		                  </div>
		
		                  <div class="col-xs-6">
		                    <small class="stat-label">% 订单较昨日增长</small>
		                    <h4>3.43%</h4>
		                  </div>
		                </div><!-- row -->
		              </div><!-- stat -->
		            ...
		            <div class="panel-heading">
		              ...
		              <div class="stat">
		                <div class="row">
		                  ...
		                  <div class="col-xs-8">
		                    <small class="stat-label">今日点击量</small>
		                    <h1>10.6k</h1>
		                  </div>
		                </div><!-- row -->
		                ...
		                <div class="mb15"></div>
										<div class="row">
		                  <div class="col-xs-6">
		                    <small class="stat-label">移动端占比</small>
		                    <h4>77%</h4>
		                  </div>
		
		                  <div class="col-xs-6">
		                    <small class="stat-label">新注册人数</small>
			                	<h4>230</h4>
		                  </div>
		                </div><!-- row -->
		            ...
		            <div class="panel-heading">
		              ...
		              <div class="stat">
		                <div class="row">
		                  ...
		                  <div class="col-xs-8">
		                    <small class="stat-label">正在使用的车位</small>
		                    <h1>5000</h1>
		                  </div>
		                </div><!-- row -->
		                ...
		                <div class="row">
		                  <div class="col-xs-6">
		                    <small class="stat-label">故障率</small>
		                    <h4>1.1%</h4>
		                  </div>
		            ...
		            <div class="panel-heading">
		              ...
		              <div class="stat">
		                <div class="row">
		                  ...
		                  <div class="col-xs-8">
		                    <small class="stat-label">今日订单金额</small>
		                    <h1>¥71K</h1>
		                  </div>
		                </div><!-- row -->
		                ...
		                <div class="row">
		                  ...
		                  <div class="col-xs-6">
		                    <small class="stat-label">昨日</small>
		                    <h4>¥88k</h4>
		                  </div>
		                </div><!-- row -->
